...
#       Defining get_pet_labels function below please be certain to replace None
...
def get_pet_labels(image_dir):
    ...
    # Creates empty dictionary name results_dic
    results_dic = dict()
    ...
    pet_labels = ["beagle", "boston terrior"]
    ...
    # Iterating through a dictinoary printing all keys & their associated values
    print("\nPrinting all key-value pairs in dictinoary results_dic:")
